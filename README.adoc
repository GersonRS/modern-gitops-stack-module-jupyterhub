...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/service[kubernetes_service.jupyterhub] (data source)
...
|[[output_cluster_dns]] <<output_cluster_dns,cluster_dns>> |Jupyterhub cluster dns
|[[output_cluster_ip]] <<output_cluster_ip,cluster_ip>> |Jupyterhub cluster ip internal
|[[output_endpoint]] <<output_endpoint,endpoint>> |Jupyterhub endpoint external
|===
// END_TF_TABLES
====
